...
class ExecutorInfo(BaseModel):
    ...
    config: Union[PositionExecutorConfig, XEMMExecutorConfig, ArbitrageExecutorConfig, DCAExecutorConfig, TWAPExecutorConfig, ExecutorConfigBase, MMExecutorConfig, WashExecutorConfig]
    net_pnl_pct: Decimal
